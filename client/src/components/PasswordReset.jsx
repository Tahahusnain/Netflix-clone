...
const PasswordReset = () => {
  ...
  return (
    <div className="main flex">
      ...
      <div className="header flex items-center flex-wrap justify-between p-4 w-full h-16">
        ...
        <div className="btn-signIn flex-wrap mr-20">
          <a
            href="/"
            role="button"
      ...
      <div className="confirm-email flex items-center mx-auto h-auto my-20 absolute inset-0 max-w-[60%] justify-center">
        <div className="Login-help flex flex-col h-[90%] w-[450px] p-6 bg-[#F3F3F3] rounded-sm ">
          ...
          <form onSubmit={handleSubmit}>
            <div className="input-pass">
              <input
                type="password"
                className="w-full h-12 mb-6 rounded-sm px-3 py-2 text-[16px] block border border-[#B3B3B3] outline-[#B3B3B3]"
                placeholder="Password"
                ref={passwordRef}
              />
              <span className="absolute top-[10.125rem] text-[12px] text-red-500">
                {validPass &&
                  "Password must include [A-Z, a-z, 0-9, and a special] characters."}
              </span>
              <input
                type="password"
                className="w-full h-12 mt-3 rounded-sm px-3 py-2 text-[16px] block border border-[#B3B3B3] outline-[#B3B3B3]"
